...
// Read from .env (VITE_API_URL) — falls back to local default
...
// Multi-pose registration (5 poses via browser webcam)
export const registerStudentMulti = (formData) =>
  api.post("/register_student_multi", formData, {
    headers: { "Content-Type": "multipart/form-data" }
  });
...
// ============================================================
// CONFIG (dynamic settings from backend .env)
// ============================================================
export const getBatchOptions    = ()        => api.get("/config/batches");
